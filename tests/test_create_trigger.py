...
class Test_create_trigger(unittest.TestCase):
    def test_create_trigger(self):
        ...
        created_trigger = gtm_generator.handle_trigger(service, work_space, triggers, operation="CREATE")
        self.assertTrue(created_trigger[0]["name"], "test Tag")